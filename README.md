...
Additionally, the Red5 TrueTime WatchParty™ application requires communication with the [Conference API](https://www.red5.net/docs/red5-cloud/development/sdks/conference-sdk/) for the [Red5 Pro Server](https://www.red5pro.com/).
